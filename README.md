...
- Apps that gate a feature on "Wi-Fi only" (e.g. Google Photos backup) actually check for an
  *unmetered* network, and Android marks any VPN as metered by default regardless of the real
